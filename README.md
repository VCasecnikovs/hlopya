...
<div align="center">
  <img src="docs/images/recording.png" alt="Hlopya recording a live session" width="900" />
  <p><sub>Live recording — floating timer in the corner, sessions list updating in real time, ready for your notes.</sub></p>
</div>
...
## You write the rough notes, Claude rewrites them

<table>
  <tr>
    <td width="50%" valign="top">
      <img src="docs/images/notes.png" alt="My Notes tab — what you type during the call" />
      <p align="center"><sub><b>My Notes</b> — type whatever you want during the call. Half-words, half-thoughts, fine.</sub></p>
    </td>
    <td width="50%" valign="top">
      <img src="docs/images/enhanced.png" alt="Enhanced tab — Claude's structured rewrite" />
      <p align="center"><sub><b>Enhanced</b> — Claude reads the diarized transcript + your notes and rewrites them into clean sections. Russian, English, mixed — doesn't care.</sub></p>
    </td>
  </tr>
</table>

Sidebar = every recorded session. Top = audio waveform. Bottom = full diarized transcript, **Me** vs **Them**, every line timestamped and copy-friendly.
