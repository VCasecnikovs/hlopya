...
<div align="center">
  <img src="docs/images/hero.png" alt="Hlopya main window with diarized Russian transcript" width="900" />
</div>
...
<img src="docs/images/notes.png" alt="My Notes tab + transcript with diarization" width="900" />

Sidebar = every recorded session. Top = audio waveform. Below = your personal notes during the call (left) or the AI-enriched version (right). Bottom = full diarized transcript, **Me** vs **Them**, every line timestamped and copy-friendly.
